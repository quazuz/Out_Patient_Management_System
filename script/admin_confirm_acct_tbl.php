...
<div class="sidebar">
  ...
  <div class="space">
  	...
  	<div id="type">
    <h1><span class="fa fa-info-circle"></span> &nbsp; Accountant Pannel</h1>
    <h2>
    	<div class="type-text">
        <p>doctor</p>
        <li>24</li>
    ...
    <div class="type-text">
        ...
        <div class="ilist">
         ...
         <li class="active"><a href=""><span class="fa fa-bars fa-2x"></span>Confirm Payment</a></li>
         
        </div>
        <div class="height">
    <div class="report" style="width:710px">
    	<section class="report_content" style="margin-left:50px">


     <table style="width:660px; margin-left:-30px">
      <thead>
      <tr id="theader">
        <th>
          <strong>S/N</strong>
      ...
      <?php
      $user = $_SESSION['id'];
      $query = mysql_query("SELECT acctid, patient_name, drug_name, price, status, date_posted, description FROM account") or die(mysql_error());
      ...
      echo "<tr id=\"view\">"; 
          echo"<td class=\"table_data\">" .$test['acctid']."</td>";
          ...
          echo"<td class=\"table_data\">" .$test['status']."</td>";
