...
<?php
    ...
    $sql_query="SELECT dpid, patient_name, doctor_name, department, date_posted, history, med FROM doc_pharm WHERE flag = 1 ORDER BY date_posted DESC";
$query=mysql_query($sql_query);
if(isset($_GET['dpid']))
{
  $sql_query="UPDATE doc_pharm SET flag = -1 WHERE dpid=".$_GET['dpid'];
...
function delete_id(id)
{
  ...
  {
    window.location.href='admin_doc.php?dpid='+id;
  }
}
</script>
</head>
...
<div class="sidebar">
	...
	<section class="wrapper" style="max-width:870px; ">
  ...
  <div class="space">
    ...
    <div class="type-text">
    	...
    	<div id="table" style="width:820px">
        <div class="container">
        <div class="ilist">
         <!--<li ><a href="pharmacist.php"><span class="fa fa-plus fa-2x"></span>add patient</a></li>-->
         <li class="active"><a href=""><span class="fa fa-bars fa-2x"></span>Patient's Prescription</a></li>
         
        </div>
        <div class="height">
    <div class="report" style="width:729px">
    	<section class="report_content" style="margin-left:10px">
       ...
       if(mysql_num_rows($query)>0)
  {
    while($test = mysql_fetch_array($query))
    {
        ...
        $id = $test['dpid_id'];
      /*$user = $_SESSION['id'];
      $query = mysql_query("SELECT dpid, patient_name, doctor_name, department, date_posted, history, med FROM doc_pharm WHERE flag = 1") or die(mysql_error());
      ...
      echo "<tr id=\"view\">"; 
          echo"<td class=\"table_data\">" .$test['dpid']."</td>";
          ...
          echo"<td class=\"table_data\">" .$test['history']."</td>";
          echo"<td class=\"table_data\">" .$test['med']."</td>";
          //echo"<td class=\"table_data\"><a href='=$id'>" ."Edit"."</a></td>";
         echo"<td class=\"table_data\"><a href='javascript:delete_id($test['dpid'];)'>" ."Delete"."</a></td>";

          
          //echo"<td class=\"table_data\"><a href='../del.php?bookcase_id=$id'>" ."delete"."</a></td>";*/
        ?>
        <tr>
            <td><?php echo $test['dpid']; ?></td>
            <td><?php echo $test['patient_name']; ?></td>
            <td><?php echo $test['doctor_name']; ?></td>
            <td><?php echo $test['department']; ?></td>
            <td><?php echo $test['date_posted']; ?></td>
            <td><?php echo $test['history']; ?></td>
            <td><?php echo $test['med']; ?></td>

           
            <td align="center"><a href="javascript:delete_id(<?php echo $test['dpid']; ?>)">Delete</a></td>
            </tr>
