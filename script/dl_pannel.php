  ...
  <div class="space">
    ...
    <div class="type-text">
      ...
      <div id="table">
        <div class="container">
        <div class="ilist">
         <li class="active"><a href=""><span class="fa fi-wrench fa-2x"></span>edit prescription</a></li>
         <li><a href=""><span class="fa fa-bars fa-2x"></span>prescription list</a></li>
         <li><a href="doctor_add_prescription.html"><span class="fa fa-plus fa-2x"></span>add prescription</a></li>
    ...
    <button type="submit">send prescription to lab</button>
