...
<div class="sidebar">
  ...
  <div class="space">
  	...
  	<div id="type">
    <h1><span class="fa fa-info-circle"></span> &nbsp; Health Officer Pannel</h1>
    <h2>
    	<div class="type-text">
        <p>doctor</p>
        <li>24</li>
    ...
    <div class="type-text">
        ...
        <div class="container">
        <div class="ilist">
         <!--<li ><a href="nurse.php"><span class="fa fa-plus fa-2x"></span>add patient</a></li>-->
    ...
    <div class="report">
     ...
     <table>
      ...
      <?php
      $user = $_SESSION['id'];
      $query = mysql_query("SELECT tid, patient_name, date_posted FROM treatment") or die(mysql_error());
      ...
      echo "<tr id=\"view\">"; 
          echo"<td class=\"table_data\">" .$test['tid']."</td>";
