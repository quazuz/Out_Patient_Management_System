...
<head>
<meta charset="utf-8">
<title>Accra Ridge Regional Hospital | Nurse Bed ward ::</title>
...
<div class="sidebar">
    ...
    <li class="active"><a href=""><span></span>bed ward</a></li>
  ...
  <div class="space">
  	...
  	<div id="type">
    <h1><span class="fa fa-info-circle"></span> &nbsp; Nurse bed ward pannel</h1>
  
    </div>
    	<div id="table">
        <div class="container">
        <div class="ilist">
        <li class="active"><a href=""><span class="fa fa-user fa-2x"></span>bed ward</a></li>
        </div>
        <div class="height">
    <div class="report">
        ...
        <h2>
        <input type="checkbox" style="width:auto">Yes
        </h2>
        <h2>
        <input type="checkbox" style="width:auto">No
        </h2>
