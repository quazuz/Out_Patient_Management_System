...
<div class="sidebar">
  ...
  <div class="space">
    ...
    <div class="type-text">
        ...
        <div class="container">
        <div class="ilist">
         <li class="active"><a href=""><span class="fa fa-plus fa-2x"></span>add patient</a></li>
         <li><a href="lab_doc.php"><span class="fa fa-bars fa-2x"></span>View Result</a></li>
         
        </div>
        <div class="height">
    <div class="report" style="float:left; margin-left:30px">
    	<section class="report_content">
        <form method="post" action="dlab.php">
    ...
    <button type="submit" name="submit">send prescription to lab</button>
