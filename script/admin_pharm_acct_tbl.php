...
<div class="sidebar">
	...
	<section class="wrapper" style="max-width:1100px; margin-left:200px">
    
  <div class="space">
  
  	<div id="type">
    <h1><span class="fa fa-info-circle"></span> &nbsp; Pharmacist Pannel</h1>
    <h2>
    	<div class="type-text">
        <p>doctor</p>
        <li>24</li>
    ...
    <div class="type-text">
    	...
    	<div id="table" style="width:1100px">
        <div class="container" style="width:980px; margin-left:-17px">
        <div class="ilist">
        ...
        <div class="height">
    <div class="report" style="width:965px">
